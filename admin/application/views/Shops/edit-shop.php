                ...
                <form role="form" method="post" class="validate" enctype="multipart/form-data">
					...
					<div class="form-group col-md-6">
						<div class="img-wrapper">
							<img src="<?php echo $data->image; ?>" width="100px;" height="100px" class="img-responsive"/>
						</div>
					</div>
                    <div class="clearfix"></div>
					 <div class="ln_solid"></div>
                      <div class="form-group text-center">
							<button type="submit" class="btn btn-custom"><i class="glyphicon glyphicon-save"></i> Update Shop</button>
					  </div>
                    <div class="clearfix"></div>
