...
class Shop extends CI_Controller {
	...
	{
		$sub_service_id = $this->service_model->get_subservice(array('service_id'=>$this->input->post('service_id')));
			if($sub_service_id){
				$template['msg']= 'success';
				$template['subservices'] =$sub_service_id;
				$template['service_id'] = $this->input->post('service_id');
			}
			else{
				$template['msg'] = 'fail';
				$template['service_id'] = $this->input->post('service_id');
	...
	public function assign_service() {
	  ...
	  $template['page'] = 'Shops/assign-service';
		...
		$template['services_sub_cat'] = $this->service_model->get_subservice(NULL);
		//echo "hello"; 
		//print_r($template['services_sub_cat']);
		//die;
